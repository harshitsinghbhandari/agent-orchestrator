    ...
    skills: [
      {
        ...
        description:
          "Create, list, rename, and delete branch- or PR-scoped Git worktree workspaces.",
      ...
      },
      {
        ...
        description:
          "Launch coding-agent sessions (Claude Code, Codex, OpenCode, and other CLI agents) with a prompt inside a workspace.",
      ...
      },
      {
        ...
        name: "Task tracking",
        description:
          `Create, search, update, and delete tasks in ${COMPANY.NAME}.`,
